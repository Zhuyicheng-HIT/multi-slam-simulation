...
OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED=${OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED:-false}
FLOW_LEVER_ARM_COMPENSATION_ENABLED=${FLOW_LEVER_ARM_COMPENSATION_ENABLED:-true}
...
ENABLE_LIDAR_CALIBRATION_MOTION=${ENABLE_LIDAR_CALIBRATION_MOTION:-true}
...
RELOCALIZATION_VELOCITY_POLICY=${RELOCALIZATION_VELOCITY_POLICY:-rotate}
RELOCALIZATION_BIAS_POLICY=${RELOCALIZATION_BIAS_POLICY:-preserve}
RELOCALIZATION_STATIONARY_MAXIMUM_SPEED_MPS=${RELOCALIZATION_STATIONARY_MAXIMUM_SPEED_MPS:-0.35}
...
setsid env \
  ...
  optical_flow_velocity_factor_enabled:="$OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED_ARG" \
  flow_lever_arm_compensation_enabled:="$FLOW_LEVER_ARM_COMPENSATION_ENABLED_ARG" \
  ...
  enable_lidar_calibration_motion:="$ENABLE_LIDAR_CALIBRATION_MOTION_ARG" \
  ...
  subspace_information_handoff_enabled:="$SUBSPACE_INFORMATION_HANDOFF_ENABLED_ARG" \
  axis_handoff_enable_x:="$AXIS_HANDOFF_ENABLE_X_ARG" \
  axis_handoff_enable_y:="$AXIS_HANDOFF_ENABLE_Y_ARG" \
  axis_handoff_enable_z:="$AXIS_HANDOFF_ENABLE_Z_ARG" \
  ...
  relocalization_velocity_policy:="$RELOCALIZATION_VELOCITY_POLICY" \
  relocalization_bias_policy:="$RELOCALIZATION_BIAS_POLICY" \
  relocalization_stationary_maximum_speed_mps:="$RELOCALIZATION_STATIONARY_MAXIMUM_SPEED_MPS" \
