...
export VALIDATION_MINIMUM_PREFLIGHT_RTF=${VALIDATION_MINIMUM_PREFLIGHT_RTF:-0.12}
export ENABLE_RELIABILITY_RECORD=${ENABLE_RELIABILITY_RECORD:-0}
export VALIDATION_PERFORMANCE_PROFILING=${VALIDATION_PERFORMANCE_PROFILING:-false}
