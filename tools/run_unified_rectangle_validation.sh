...
VALIDATION_OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED=${VALIDATION_OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED:-false}
VALIDATION_FLOW_LEVER_ARM_COMPENSATION_ENABLED=${VALIDATION_FLOW_LEVER_ARM_COMPENSATION_ENABLED:-true}
...
VALIDATION_ENABLE_FCU_FLOW=${VALIDATION_ENABLE_FCU_FLOW:-0}
VALIDATION_ENABLE_FCU_RANGE=${VALIDATION_ENABLE_FCU_RANGE:-0}
VALIDATION_ENABLE_NONGPS_FLOW=${VALIDATION_ENABLE_NONGPS_FLOW:-0}
VALIDATION_ENABLE_SITL_FLOW=${VALIDATION_ENABLE_SITL_FLOW:-0}
...
VALIDATION_MAVROS_PLUGINLISTS_FILE=${VALIDATION_MAVROS_PLUGINLISTS_FILE:-}
if [[ -z "$VALIDATION_MAVROS_PLUGINLISTS_FILE" ]]; then
  if [[ "$VALIDATION_ENABLE_FCU_FLOW" == "1" ||
    "$VALIDATION_ENABLE_FCU_RANGE" == "1" ||
    "$VALIDATION_ENABLE_NONGPS_FLOW" == "1" ]]; then
    VALIDATION_MAVROS_PLUGINLISTS_FILE="$REPO_ROOT/install/multi_slam_uav_sim/share/multi_slam_uav_sim/config/mavros_validation_flow_pluginlists.yaml"
  else
    VALIDATION_MAVROS_PLUGINLISTS_FILE="$REPO_ROOT/install/multi_slam_uav_sim/share/multi_slam_uav_sim/config/mavros_validation_pluginlists.yaml"
  fi
fi
...
VALIDATION_SUBSPACE_INFORMATION_HANDOFF_ENABLED=${VALIDATION_SUBSPACE_INFORMATION_HANDOFF_ENABLED:-false}
...
setsid env HEADLESS=1 REQUIRE_GAZEBO_GPU=1 ENABLE_D435_POINTCLOUD=false \
  ...
  ENABLE_FCU_FLOW="$VALIDATION_ENABLE_FCU_FLOW" \
  ENABLE_FCU_RANGE="$VALIDATION_ENABLE_FCU_RANGE" \
  ENABLE_NONGPS_FLOW="$VALIDATION_ENABLE_NONGPS_FLOW" \
  ENABLE_SITL_FLOW="$VALIDATION_ENABLE_SITL_FLOW" \
  MAVROS_PLUGINLISTS_FILE="$VALIDATION_MAVROS_PLUGINLISTS_FILE" \
...
setsid env ENABLE_VISION="$validation_enable_vision_arg" \
  ...
  SUBSPACE_INFORMATION_HANDOFF_ENABLED="$VALIDATION_SUBSPACE_INFORMATION_HANDOFF_ENABLED" \
  ...
  OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED="$VALIDATION_OPTICAL_FLOW_VELOCITY_FACTOR_ENABLED" \
  FLOW_LEVER_ARM_COMPENSATION_ENABLED="$VALIDATION_FLOW_LEVER_ARM_COMPENSATION_ENABLED" \
