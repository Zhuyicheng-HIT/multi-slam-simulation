...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    result = {
        ...
        "body_lidar_translation_measured": contract.body_lidar.translation is not None,
        "camera_lidar_calibrated": contract.camera_lidar.status == "calibrated",
        "hardware_tf_publishable": closure.status == "MEASURED",
    ...
    return 2 if args.require_complete and closure.status != "MEASURED" else 0
