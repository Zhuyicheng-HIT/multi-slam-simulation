...
RELOCALIZATION_MOTION_ENABLED=${RELOCALIZATION_MOTION_ENABLED:-false}
RELOCALIZATION_MOTION_RADIUS_M=${RELOCALIZATION_MOTION_RADIUS_M:-0.6}
RELOCALIZATION_MOTION_SPEED_MPS=${RELOCALIZATION_MOTION_SPEED_MPS:-0.25}
RELOCALIZATION_MOTION_YAW_RATE_DEG_S=${RELOCALIZATION_MOTION_YAW_RATE_DEG_S:-12.0}
RELOCALIZATION_MOTION_YAW_STEP_DEG=${RELOCALIZATION_MOTION_YAW_STEP_DEG:-45.0}
RELOCALIZATION_MOTION_SETTLE_S=${RELOCALIZATION_MOTION_SETTLE_S:-2.5}
...
RELOCALIZATION_MOTION_RADIUS_M_ARG=$(as_double "$RELOCALIZATION_MOTION_RADIUS_M")
RELOCALIZATION_MOTION_SPEED_MPS_ARG=$(as_double "$RELOCALIZATION_MOTION_SPEED_MPS")
RELOCALIZATION_MOTION_YAW_RATE_DEG_S_ARG=$(as_double "$RELOCALIZATION_MOTION_YAW_RATE_DEG_S")
RELOCALIZATION_MOTION_YAW_STEP_DEG_ARG=$(as_double "$RELOCALIZATION_MOTION_YAW_STEP_DEG")
RELOCALIZATION_MOTION_SETTLE_S_ARG=$(as_double "$RELOCALIZATION_MOTION_SETTLE_S")
...
case "${RELOCALIZATION_MOTION_ENABLED,,}" in
  1|true|yes|on) RELOCALIZATION_MOTION_ENABLED_ARG=true ;;
  0|false|no|off) RELOCALIZATION_MOTION_ENABLED_ARG=false ;;
  *) printf 'RELOCALIZATION_MOTION_ENABLED must be true/false or 1/0, got %s.\n' "$RELOCALIZATION_MOTION_ENABLED" >&2; exit 2 ;;
esac
if [[ "$ROUTE_FEEDBACK_SOURCE" == "gazebo_truth" ]] && \
...
Relocalization motion: enabled=$RELOCALIZATION_MOTION_ENABLED_ARG,
        radius=$RELOCALIZATION_MOTION_RADIUS_M m, speed=$RELOCALIZATION_MOTION_SPEED_MPS m/s,
        yaw_rate=$RELOCALIZATION_MOTION_YAW_RATE_DEG_S deg/s,
        yaw_step=$RELOCALIZATION_MOTION_YAW_STEP_DEG deg,
        settle=$RELOCALIZATION_MOTION_SETTLE_S s
...
ros2 run multi_slam_uav_sim guided_s_curve_waypoints --ros-args \
  ...
  -p relocalization_motion_enabled:="$RELOCALIZATION_MOTION_ENABLED_ARG" \
  -p relocalization_motion_radius_m:="$RELOCALIZATION_MOTION_RADIUS_M_ARG" \
  -p relocalization_motion_speed_mps:="$RELOCALIZATION_MOTION_SPEED_MPS_ARG" \
  -p relocalization_motion_yaw_rate_deg_s:="$RELOCALIZATION_MOTION_YAW_RATE_DEG_S_ARG" \
  -p relocalization_motion_yaw_step_deg:="$RELOCALIZATION_MOTION_YAW_STEP_DEG_ARG" \
  -p relocalization_motion_settle_s:="$RELOCALIZATION_MOTION_SETTLE_S_ARG" \
