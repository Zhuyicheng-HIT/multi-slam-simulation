...
class GzMid360PointCloudBridge(RosNode):
    ...
    def _points_from_scan(self, msg):
        ...
        for idx in range(0, point_count, self.point_stride):
            ...
            tag = 0x10
            line = v_idx % 4
            points.append((x, y, z, intensity, tag, line))
        return points
    ...
    def _cloud_msg(self, points, stamp, frame_id):
        ...
        msg.is_dense = False
        msg.data = b"".join(struct.pack("<ffffBB", *p) for p in points)
        return msg
    ...
    def _scan_cb(self, msg):
        ...
        if self.publish_registered:
            ...
            for point in sensor_points:
                ...
                world_points.append((rx + px, ry + py, rz + pz, point[3], point[4], point[5]))
