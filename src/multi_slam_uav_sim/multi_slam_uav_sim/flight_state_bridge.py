...
class FlightStateBridge(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(
            NavSatFix, f"{self.mavros_ns}/global_position/global", self._global_fix_cb, mavros_sensor_qos)
        self.create_subscription(
    ...
    def _publish_interface_status(self):
        ...
        parts = []
        for name in ["state", "local_pose", "local_odom", "global_local_odom", "global_fix", "imu", "velocity"]:
