...
private:
  ...
  void publish_static_tf()
  {
    ...
    std::vector<geometry_msgs::msg::TransformStamped> transforms{
      transform("base_link", "front_d435i_link", 0.30, 0.0, 0.02),
      transform("front_d435i_link", "front_d435i_color_frame"),
      transform("front_d435i_color_frame", color_frame_, 0.0, 0.0, 0.0, true),
      transform("front_d435i_link", "front_d435i_depth_frame"),
      transform("front_d435i_depth_frame", depth_frame_, 0.0, 0.0, 0.0, true),
      transform("front_d435i_link", imu_frame_)};
